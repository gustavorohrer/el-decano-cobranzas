...
const Layout: React.FC<LayoutProps> = ({ children, activeTab, setActiveTab, userRole, onLogout, isOffline }) => {
  ...
  const menuItems = [
    ...
    { id: 'advertising', label: 'Publicidad', icon: LayoutGrid, roles: [UserRole.ADMIN_GENERAL, UserRole.TESORERO, UserRole.PRESIDENTE, UserRole.COBRADOR] },
    { id: 'accounting', label: 'Contabilidad', icon: Wallet, roles: [UserRole.ADMIN_GENERAL, UserRole.TESORERO, UserRole.PRESIDENTE] },
    { id: 'reports', label: 'Reportes', icon: BarChart3, roles: [UserRole.ADMIN_GENERAL, UserRole.TESORERO, UserRole.PRESIDENTE] },
